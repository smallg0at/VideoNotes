...
try{
        ...
        interaction: {
            ...
            checkIfIE: function() {
                if (navigator.userAgent.indexOf('Trident') != -1 && navigator.userAgent.indexOf('Edge') == -1) {
                    ...
                    settings.isIE = true
                    document.querySelector('#load-text').innerHTML = "本页面不支持IE，请更换浏览器使用"
                }
            },
            checkLS: function() {
                try {
    ...
    document.querySelector('#load-text').innerHTML = '发生错误：'+e
}

export {settings, DEBUGMODE, settingUtils, nwWindow, nwClip}